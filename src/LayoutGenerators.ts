...
// // export interface IFunctionRect {
// //   top: () => number;
// //   left: () => number; 
// //   right: () => number; 
// //   bottom: () => number;
...
// export function sideBarHeaderContentFooterLayout(width: number, height: number) {
//   // let layout: Map<string, IFunctionRect> = new Map();
//   // function get(name: string): IFunctionRect {
//   //   const rect = layout.get(name);
//   //   if (rect) {
//   //     return rect;
//   //   }
...
//     name: 'content',
//     location: {x: sideRight, y: headerHeight},
//     blockSize: {x: sideRight, y: height - (footerHeight + headerHeight)}
//   }
...
//     top: content.bottom,
//     right: width,
//     bottom: content.bottom + footerHeight
//   }
...
//   return new LayoutGenerator(layouts, params);
// }
