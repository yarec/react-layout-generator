...
it('stringToUnit return correct value', () => {
  ...
  expect(toUnit('40pmin')).toEqual(Unit.pmin)
  expect(toUnit('40pmax')).toEqual(Unit.pmax)
  expect(toUnit('30pw')).toEqual(Unit.pw)
  expect(toUnit('1ph')).toEqual(Unit.ph)
  expect(toUnit('40vmin')).toEqual(Unit.vmin)
  expect(toUnit('40vmax')).toEqual(Unit.vmax)
  expect(toUnit('30vw')).toEqual(Unit.vw)
  expect(toUnit('1vh')).toEqual(Unit.vh)
...
it('namedUnit return correct value', () => {
  ...
  expect(namedUnit(Unit.pmin) === 'pmin')
  expect(namedUnit(Unit.pmax) === 'pmax')
  expect(namedUnit(Unit.pw) === 'pw')
  expect(namedUnit(Unit.ph) === 'ph')
